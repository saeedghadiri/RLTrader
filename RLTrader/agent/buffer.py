...
from RLTrader.apps.rltrader.config import BUFFER_UNBALANCE_GAP
import random
...
class ReplayBuffer:
    ...
    def append(self, state, action, r, sn, d):
        ...
        """
        self.buffer.append([state[0], state[1], action, np.expand_dims(r, -1), sn[0], sn[1], np.expand_dims(d, -1)])
